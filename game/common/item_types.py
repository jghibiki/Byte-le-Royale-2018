...
class Armor(ArmorItem):
    def init(self, level, unit_class):
        stats = {
            ...
            UnitClass.knight:    [15000, 16500, 18000, 19500, 21000, 22500, 24000, 25500, 27000, 28500],
            UnitClass.brawler:   [13500, 15000, 16500, 18000, 19500, 21000, 22500, 24000, 25500, 27000],
            UnitClass.pikeman:   [14250, 15750, 17250, 18750, 20250, 21750, 23250, 24750, 26250, 27750],
            UnitClass.rogue:     [11500, 13000, 14500, 16000, 17500, 19000, 20500, 22000, 23500, 25000],
            UnitClass.sorcerer:  [ 9000, 10500, 12000, 13500, 15000, 16500, 18000, 19500, 21000, 22500],
            UnitClass.magus:     [ 8500, 10000, 11500, 13000, 14500, 16000, 17500, 19000, 20500, 22000],
            UnitClass.wizard:    [ 9750, 11250, 12750, 14250, 15750, 17250, 18750, 20250, 21750, 23250],
            UnitClass.alchemist: [10750, 12250, 13750, 15250, 16750, 18250, 18750, 19750, 21750, 24250]
        }
